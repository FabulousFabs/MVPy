...
class _Scaler_numpy(sklearn.base.BaseEstimator):
    """A standard scaler for numpy arrays. Note that this class is not exported and should not be used directly.
...
class _Scaler_torch(sklearn.base.BaseEstimator):
    """A standard scaler for torch tensors. Note that this class is not exported and should not be called directly.
