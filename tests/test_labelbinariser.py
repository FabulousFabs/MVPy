'''
A series of unit tests for mvpy.estimators.LabelBinariser
'''
...
def test_LabelBinariser_identity_numpy():
    ...
    # setup binariser
    label = mv.estimators.LabelBinariser().to_numpy()
...
def test_LabelBinariser_identity_torch():
    ...
    # setup binariser
    label = mv.estimators.LabelBinariser().to_torch()
    L = label.fit_transform(y)
...
def test_LabelBinariser_F5_CX_int_compare_numpy_torch(y_F5_CX_int):
    ...
    # setup binarisers
    label_np = mv.estimators.LabelBinariser().to_numpy()
    label_tr = mv.estimators.LabelBinariser().to_torch()
...
def test_LabelBinariser_identity_numpy_custom():
    ...
    # setup binariser
    label = mv.estimators.LabelBinariser(
        neg_label = -2, 
        pos_label = 2
    ).to_numpy()
    L = label.fit_transform(y)
...
def test_LabelBinariser_F5_CX_int_compare_numpy_torch_custom(y_F5_CX_int):
    ...
    # setup binarisers
    label_np = mv.estimators.LabelBinariser(
        neg_label = -2, 
        pos_label = 2
    ).to_numpy()
    label_tr = mv.estimators.LabelBinariser(
        neg_label = -2, 
        pos_label = 2
    ).to_torch()
